  ...
  return (
    <Container>
      ...
      <div className="middle">
        <Type className="type" type={listing?.type}>
          {listing?.type}
        </Type>
...
const Type = styled.p`
  ...
  position: absolute;
  text-align: center;
  color: ${(props) => props.type === "Received" && "var(--blue)"};
  color: ${(props) => props.type === "Viewed" && "var(--bright)"};
  color: ${(props) => props.type === "Responded" && "var(--green)"};
`;
